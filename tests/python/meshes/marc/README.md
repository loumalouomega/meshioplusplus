...
| `mixed_free.dat` | free (comma) format: a brick, a brick with collapsed nodes (a wedge), a 10-node tetrahedron, a shell quad, a beam, an element of a type meshio++ does not read (skipped with a warning), and a face set (skipped with a warning) |
