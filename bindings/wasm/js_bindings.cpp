 ...
 *   blocks, and VTKHDF's poly-vertex/poly-line/strip cells). Not "ignore all
 *   errors": a malformed file still throws.
 * @param rPiece keep only this piece of a partitioned file (VTKHDF partitions or
