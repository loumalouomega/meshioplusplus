...
> [GiD postprocess](https://www.gidsimulation.com/) (output only, via a vendored gidpost) (`.post.msh`/`.post.res`, `.post.bin`, `.post.h5`),
...
```cmake
find_package(meshioplusplus 10.18.0 EXACT CONFIG REQUIRED COMPONENTS CXX)
