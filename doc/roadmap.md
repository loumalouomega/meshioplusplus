...
4. **Performance ([§4](#_4-performance))** — the measured regressions first, then the isolated wins (`b64decode`, the lazy CLI import, `optimize_volume`), then the shared facet table.
