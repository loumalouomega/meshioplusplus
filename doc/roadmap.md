...
### 1.11 Elmer and FEBio, remaining halves — **S** each
...
1. **Next FEM wave:** §1.3 Abaqus `.fil` → §1.1 libMesh → §1.2 Z88; §1.11 and §1.12 as Elmer, FEBio, Patran, Femap and MFEM users ask.
