...
- Colouring shares its resolution layer with the TikZ writer: `cpp/include/meshioplusplus/detail/face_color.hpp` and its twin `src/meshioplusplus/_facecolor.py`, over the colormap tables in `detail/colormap.hpp` / `_colormap.py`.
