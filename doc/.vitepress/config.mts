    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "Vendor-runtime routes",
            link: "/vendor_routes",
            collapsed: true,
            items: [
              { text: "Abaqus .odb", link: "/routes/abaqus_odb" },
              { text: "Marc .t16", link: "/routes/marc_t16" },
              { text: "Ansys via PyDPF", link: "/routes/ansys_dpf" },
              { text: "Femap .modfem", link: "/routes/femap_modfem" },
              { text: "Tecplot .szplt", link: "/routes/tecplot_szplt" },
            ],
          },
      ...
      },
      {
        ...
        items: [
          ...
          { text: "abaqus_fil", link: "/formats/abaqus_fil" },
          ...
          { text: "elmer", link: "/formats/elmer" },
          { text: "ensight", link: "/formats/ensight" },
          { text: "exodus", link: "/formats/exodus" },
          { text: "febio", link: "/formats/febio" },
          { text: "femap", link: "/formats/femap" },
          ...
          { text: "lsdyna_binout", link: "/formats/lsdyna_binout" },
          { text: "lsdyna_d3plot", link: "/formats/lsdyna_d3plot" },
          { text: "marc", link: "/formats/marc" },
          { text: "mdpa", link: "/formats/mdpa" },
          { text: "med", link: "/formats/med" },
          { text: "medit", link: "/formats/medit" },
          { text: "mfem", link: "/formats/mfem" },
          ...
          { text: "nastran_op2", link: "/formats/nastran_op2" },
          ...
          { text: "patran", link: "/formats/patran" },
          ...
          { text: "vtx", link: "/formats/vtx" },
          { text: "wkt", link: "/formats/wkt" },
          { text: "xdmf", link: "/formats/xdmf" },
          { text: "xplt", link: "/formats/xplt" },
          { text: "xyz", link: "/formats/xyz" },
          { text: "z88", link: "/formats/z88" },
