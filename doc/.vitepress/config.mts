    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "VTKHDF time series", link: "/vtkhdf_time_series" },
      ...
      },
      {
        ...
        items: [
          ...
          { text: "PhysicsNeMo basics", link: "/physicsnemo/overview" },
          { text: "\u00b7 Core and checkpoints", link: "/physicsnemo/core_and_checkpoints" },
          { text: "\u00b7 Models", link: "/physicsnemo/models" },
          { text: "\u00b7 Layers and functionals", link: "/physicsnemo/layers_and_functionals" },
          { text: "\u00b7 Data and datapipes", link: "/physicsnemo/data_and_datapipes" },
          { text: "\u00b7 Mesh and geometry", link: "/physicsnemo/mesh_and_geometry" },
          { text: "\u00b7 Symbolic and physics", link: "/physicsnemo/symbolic_and_physics" },
          { text: "\u00b7 Diffusion and deployment", link: "/physicsnemo/diffusion_and_deployment" },
          { text: "\u00b7 Uncertainty and guardrails", link: "/physicsnemo/uncertainty_and_guardrails" },
          { text: "\u00b7 Active learning", link: "/physicsnemo/active_learning" },
          { text: "\u00b7 Training utilities", link: "/physicsnemo/training_utilities" },
          { text: "\u00b7 Distributed and scale", link: "/physicsnemo/distributed_and_scale" },
          { text: "\u00b7 Companion packages", link: "/physicsnemo/companion_packages" },
          { text: "\u00b7 Versions and compatibility", link: "/physicsnemo/versions_and_compatibility" },
        ],
      },
      {
        text: "Project",
      ...
      },
      {
        ...
        items: [
          ...
          { text: "pcd", link: "/formats/pcd" },
          { text: "permas", link: "/formats/permas" },
          { text: "ply", link: "/formats/ply" },
          { text: "pmsh", link: "/formats/pmsh" },
          { text: "pvd", link: "/formats/pvd" },
          ...
          { text: "vtkhdf", link: "/formats/vtkhdf" },
          ...
          { text: "xyz", link: "/formats/xyz" },
          { text: "zarr", link: "/formats/zarr" },
        ],
      },
    ],
