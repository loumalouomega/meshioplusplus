...
|---|---|---|
| `Block` | Arbitrarily many lines | abaqus, ansys*, avsucd, code_aster, elmer (in `mesh.names`), exodus, febio, flac3d, flux, gltf, lsdyna, mphtxt, nastran, netgen, obj, off, permas, ply, tetgen, triangle, vti, vtp, vtu |
