...
- **A new `voxel` cell type.** VTK's type 11 is deliberately unmapped in this codebase; adding it would mean a row in all 79 format tables to buy an implicit node ordering nothing needs.
