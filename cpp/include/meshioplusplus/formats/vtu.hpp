...
// Throws meshioplusplus::WriteError on unsupported input (e.g. polyhedron blocks).
...
// DataArrays for non-polyhedron meshes. Throws meshioplusplus::ReadError on anything
