        ...
        state.update(
            {
                ...
                "latent_channels": model.get("LatentChannels"),
                "num_fno_modes": model.get("NumFnoModes"),
                "patch_size": model.get("PatchSize"),
                "embed_dim": model.get("EmbedDim"),
                "width": model.get("Width"),
                "parameters": (spec.get("Operator") or {}).get("Parameters"),
                "resolution": (spec.get("Grid") or {}).get("Resolution"),
                "squeeze": (spec.get("Grid") or {}).get("Squeeze"),
                "tags": spec.get("Tags", []),
