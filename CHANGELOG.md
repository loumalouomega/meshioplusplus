...
- **Built-in colormaps** (`detail/colormap.hpp` + its `_colormap.py` twin,
  generated by `tools/gen_colormaps.py`): viridis, coolwarm and turbo as
  ...
  *regenerate* the tables, never to use them. Storing full 256-entry tables
  ...
  colour path, leaving a single index expression.
