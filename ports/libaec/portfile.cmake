# Overlay for vcpkg's registry libaec port: the registry portfile fetches its
# tarball from gitlab.dkrz.de, an institutional mirror that has repeatedly
# 429'd (rate-limited) meshioplusplus's release CI (see packages.yml history).
# This overlay is otherwise identical, but sources from the GitHub mirror the
# same organization (Deutsches Klimarechenzentrum) publishes at the same tag,
# which CI reaches reliably.
vcpkg_from_github(
